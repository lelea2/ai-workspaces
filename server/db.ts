...
const SEED_AGENTS: AgentConfig[] = [
  {
    ...
    bgLight: 'bg-emerald-50 dark:bg-emerald-900/40 border-emerald-200 dark:border-emerald-800 hover:bg-emerald-100 dark:hover:bg-emerald-900/60',
    initial: 'D',
  ...
  },
  {
    ...
    bgLight: 'bg-blue-50 dark:bg-blue-900/40 border-blue-200 dark:border-blue-800 hover:bg-blue-100 dark:hover:bg-blue-900/60',
    initial: 'R',
  ...
  },
  {
    ...
    bgLight: 'bg-rose-50 dark:bg-rose-900/40 border-rose-200 dark:border-rose-800 hover:bg-rose-100 dark:hover:bg-rose-900/60',
    initial: 'S',
  ...
  },
  {
    ...
    bgLight: 'bg-violet-50 dark:bg-violet-900/40 border-violet-200 dark:border-violet-800 hover:bg-violet-100 dark:hover:bg-violet-900/60',
    initial: 'C',
  ...
  },
  {
    ...
    bgLight: 'bg-amber-50 dark:bg-amber-900/40 border-amber-200 dark:border-amber-800 hover:bg-amber-100 dark:hover:bg-amber-900/60',
    initial: 'T',
